  ...
  dist<-   mat_hiseq_cluster_1.688_updown#mat_hiseq_cluster_rsplike
  dist2<- mat_hiseq_cluster_rsplike_updown
  
  row_counter=1
  names<-colnames(dist)
  
  setter=3 #make is 3 for 1.688 and 2 for rsp
  Threshold=40
  ...
  cytobands<-list()
  cytoband_tracker=1  #checks if the cytolength has skipped cytobands
 ...
 cytobands[as.character(22)]<-20#adding gap code
